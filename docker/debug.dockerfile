...
RUN mkdir -p /var/cache/oracle-jdk11-installer-local/ \
 && wget -O /var/cache/oracle-jdk11-installer-local/jdk-11.0.11_linux-x64_bin.tar.gz \
        https://github.com/JarryShaw/darc/raw/master/vendor/jdk-11.0.11_linux-x64_bin.tar.gz
